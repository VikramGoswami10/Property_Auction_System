    ...
    <div className="bg-gray-100 min-h-screen px-6 py-6">
      ...
      <div className="mt-6 flex justify-between items-center">
        <h2 className="text-lg font-semibold">
          {filteredProperties.length} results | Filtered Properties for Sale
        </h2>
      </div>
            ...
            <div key={auction.id} className="bg-white shadow-md rounded-lg p-4 flex">
              ...
              <div className="w-2/3 pl-4 flex flex-col justify-between">
                ...
                <p className="text-lg font-semibold text-red-500">
                  ₹ {auction.price.toLocaleString()} <span className="text-xs">(**indicative price)</span>
                </p>
